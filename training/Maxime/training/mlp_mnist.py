...
with open("../models/mlp_weights.txt", "w") as f:
    for param in model.parameters():        # iterate over all weights and biases
        for value in param.data.flatten():  # flatten tensor to 1D
